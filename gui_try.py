...
#layout = [[sg.Text("This is a tool to help you choose something \
#to eat based on what you have on your fridge :)")], [sg.Button("1")]]
...
layout = [[sg.Column(layout1, key='-COL1-'), sg.Column(layout2, visible=False, key='-COL2-'), sg.Column(layout3, visible=False, key='-COL3-')],
          [sg.Button('Cycle Layout'), sg.Button('Breakfast'), sg.Button('Lunch/Dinner'), 
          sg.Button('Snacks/Others'), sg.Button('Exit')]]
